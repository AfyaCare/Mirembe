...
angular.module('bahmni.warehouse')
    .factory('ledgerEntryService', ['$http', function ($http) {
        ...
        var getLedgers = function () {
            return $http.get(Bahmni.Common.Constants.getLedgers);
        };
        ...
        var updateLedgerEntry = function (item_id, LedgerEntryID, LedgerEntryType, quantity, BatchNo, InvoiceNo, ExpiryDate, receiveDate, price_list_id, amount, math) {
            var params = {
                item_id: item_id,
            ...
            return $http.get(Bahmni.Common.Constants.updateLedger_entry, {
                method: "GET",
                params: params,
                withCredentials: true
            });
