...
angular.module('bahmni.report')
  .factory('getSaleOrdersService', ['$http', function($http) {
    ...
    var readReports = function() {
      return $http.get(Bahmni.Common.Constants.reports, {
        method: "GET",
        headers: {
          Accept: 'text/plain'
        },
    ...
    var requestReport = function(report_name, time_period, sqlPath, period_type) {
      var params = {
      ...
      return $http.get(Bahmni.Common.Constants.reportRequest, {
        method: "GET",
        headers: {
          Accept: 'text/plain'
        },
    ...
    var previewReport = function(name, startDate, endDate) {
      var params = {
        name: name,
        startDate: startDate,
        endDate: endDate
      };
      return $http.get(Bahmni.Common.Constants.previewReport, {
        headers: {
          Accept: 'text/plain'
        },
        params: params,
