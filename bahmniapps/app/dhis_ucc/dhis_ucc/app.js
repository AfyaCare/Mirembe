'use strict';
angular
  .module('report', ['ui.router', 'bahmni.report', 'bahmni.common.domain', 'bahmni.common.patient', 'authentication', 'bahmni.common.config', 'bahmni.common.appFramework',
  ...
  .config(['$urlRouterProvider', '$stateProvider', '$httpProvider', '$bahmniTranslateProvider', '$compileProvider',
      function($urlRouterProvider, $stateProvider, $httpProvider, $bahmniTranslateProvider, $compileProvider) {
        ...
        $stateProvider
          ...
          //   views: {
          //     'content': {
          //       templateUrl: 'views/delete/paid_orders.html',
          ...
          //   views: {
          //     'content': {
          //       templateUrl: 'views/delete/cancel_orders.html',
