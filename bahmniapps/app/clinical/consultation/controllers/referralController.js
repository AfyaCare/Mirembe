...
angular.module('bahmni.clinical')
    .controller('ReferralController',['$scope', '$rootScope', '$stateParams','$window','$http','contextChangeHandler', 'spinner', 'conceptSetService',
        'messagingService', 'referralConceptSet','printPrivService', 'appService','$state','locationService','$location', 'visitConfig','sessionService','configurations', 'visitService','retrospectiveEntryService',
        function ($scope, $rootScope,$stateParams,$window, $http,contextChangeHandler, spinner, conceptSetService, messagingService, referralConceptSet,
                 printPrivService, appService,$state,locationService,$location,visitConfig,sessionService,configurations, visitService,retrospectiveEntryService) {
