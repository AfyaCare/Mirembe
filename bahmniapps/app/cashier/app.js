...
app.config(['$urlRouterProvider', '$stateProvider', '$httpProvider', '$bahmniTranslateProvider', '$compileProvider',
  function($urlRouterProvider, $stateProvider, $httpProvider, $bahmniTranslateProvider, $compileProvider) {
    ...
    $stateProvider
      ...
      .state('reconciled_orders', {
        ...
        views: {
          'content': {
            templateUrl: 'views/reconciled_orders.html',
            controller: 'reconciledOrdersController'
          }
        },
        resolve: {
          initialization: 'initialization'
...
app.run(['backlinkService', function(backlinkService) {
