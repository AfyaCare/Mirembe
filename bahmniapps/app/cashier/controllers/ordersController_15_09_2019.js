        ...
        $scope.requestControlNumber = function(saleOrderID, fullName, amount, identifier, BillGenBy) {
          ...
          $scope.printOrder = function(order) {
           ...
           // mywindow.document.write('<p style="margin: 1px;"> Service Provider Code: SP222</p>');
			...
			mywindow.document.write('<tr><td class="blanktotal" colspan="2"></td><td class="totals">SubTotal:</td><td class="totals cost">'+$scope.total+'/=</td></tr>');
			mywindow.document.write('<tr><td class="blanktotal" colspan="2" rowspan="2"></td><td class="totals">Discount:</td><td class="totals cost">'+order.discount+'/=</td></tr>');
                    var options = { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' };
                    var today  = new Date();
					var total_am=$scope.total-order.discount;
			        mywindow.document.write('<tr><td class="totals"><b>Total:</b></td><td class="totals cost"><b>'+total_am+' (TZS)</b></td></tr></tbody></table>');
                    mywindow.document.write('<table width="100%" style="font-family: serif;border: 0; font-size: 18px;" cellpadding="2">');
                    mywindow.document.write('<tr><td width="40%">Amount in Words:</td><td width="60%" style="border-bottom: 0.1mm dotted #888888;">'+covertWords(total_am)+' Tanzanian Shilling Only</td></tr>');
                   // var str=;
