...
angular.module('bahmni.cashier').controller('reconciledOrdersController', ['$scope',
    ...
    function ($scope, $rootScope, $stateParams, $state, $q,
        ...
        var getReconciliation = function () {
          var search = '';
            spinner.forPromise(
                getSaleOrdersService.getReconciledOrders(search).then(function (response) {
        ...
        $scope.search = function() {
          spinner.forPromise(getSaleOrdersService.getReconciledOrders($scope.searchName).then(function(response) {
            console.log(response.data);
