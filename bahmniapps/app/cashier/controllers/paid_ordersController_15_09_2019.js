...
angular.module('bahmni.cashier').controller('paid_ordersController', ['$scope',
    ...
    function ($scope, $rootScope, $stateParams, $state, $q,
        ...
        $scope.printReceipt = function (data) {
            ...
            mywindow.document.write('</head><body><div style="width: 900px;padding: 1em 1em; border: 1px solid; font-family: Futura; font-size: 18px"> <center>');
            ...
            mywindow.document.write('<tr><td width="40%" >Amount:</td><td width="60%" style="border-bottom: 0.1mm dotted #888888;">' + formatter.format(data.total_amount) + '(TZS)</td></tr>');
            mywindow.document.write('<tr><td width="40%">Amount in Words:</td><td width="60%" style="border-bottom: 0.1mm dotted #888888;">'+covertWords(data.total_amount)+' Tanzanian Shilling Only</td></tr></table>');
